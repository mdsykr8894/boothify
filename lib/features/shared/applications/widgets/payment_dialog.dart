...
class _PaymentDialogState extends State<PaymentDialog> {
  ...
  void _handleConfirm() async {
    ...
    if (mounted) {
      ...
      if (success) {
        ...
        final error = appProvider.errorMessage ?? 'Simulated payment processing failed. Please try again.';
  ...
  Widget build(BuildContext context) {
    ...
    // Resolve spot and package price safely
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      icon: const Icon(Icons.close_rounded, size: 24, color: AppColors.secondaryText),
                          ...
                          child: Row(
                            children: [
                              Container(
                                ...
                                child: Icon(
                                  icon,
                                  color: isSelected ? AppColors.primaryAccent : Colors.grey.shade500,
                                  size: 22,
                                ),
                              ),
                                  ...
                                  children: [
                                    Text(
                                      ...
                                      style: TextStyle(
                                        ...
                                        color: isSelected ? AppColors.primaryText : Colors.grey.shade700,
                                      ),
                                    ),
